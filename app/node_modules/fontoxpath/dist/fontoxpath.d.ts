 ...
 * @returns The query result and pending update list.
 */
export declare function evaluateUpdatingExpressionSync<TNode extends Node_2, TReturnType extends ReturnType_2>(updateScript: string, contextItem?: any | null, domFacade?: IDomFacade | null, variables?: {
    [s: string]: any;
...
export declare type EvaluateXPath = {
     ...
     */
    <TNode extends Node_2, TReturnType extends ReturnType_2>(selector: string, contextItem?: any | null, domFacade?: IDomFacade | null, variables?: {
        [s: string]: any;
